...
public class ObjectGeneratorRandomPositionUtility : MonoBehaviour
{
    [SerializeReference] private GameObject objectPrefab;
    [SerializeReference] private float radius = 0.2f;  
